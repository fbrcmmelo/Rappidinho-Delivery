...
<html> 
    <head>
        <c:import url="/head.jsp"></c:import>
            <title>Rappidinho - Pedidos</title>
        </head>
                                    ...
                                    <table class="table no-wrap">
                                        ...
                                        <tbody>
                                                ...
                                                <c:when test="${pessoa.tipoPessoa eq 'A'}">
                                                    <c:forEach var="pedido" items="${pedidos}">
                                                        ...
                                                        <tr> 
                                                            ...
                                                            <td><a href="${pageContext.request.contextPath}/CarregarPedido?idpedido=${pedido.idPedido}">Alterar</a></td>
                                            ...
                                            <c:forEach var="pedido" items="${pedidos}">
                                                <tr>    
                                                    <c:choose>
                                                        <c:when test="${pedido.pessoa.idPessoa == pessoa.idPessoa}">
                                                        <tr> 
                                                            <td>${pedido.idPedido}</td>
                                                            <td><fmt:formatDate type="date" pattern="dd/MM/yyyy" value="${pedido.dataPedido}"></fmt:formatDate></td>                                               
                                                            <td>${pedido.latDestinoPedido}</td> 
