...
public class VeiculoDAO implements GenericDAO {
    ...
    public Boolean cadastrar(Object objeto) {
        ...
        try {
            ...
            stmt.setInt(4,  oVeiculo.getPessoa().getIdPessoa());
    ...
    public List<Object> listar() {
        ...
        String sql = "select v.*, c.id_pessoa, pes.nome_pessoa from veiculo v, contratado c, pessoa pes "
                + "where v.id_pessoa = c.id_pessoa and c.id_pessoa = pes.id_pessoa order by v.id_veiculo desc;";// nome da tabela do banco (TUDOMINUSCULO)
        ...
        try {
            ...
            while (rs.next()) {
                ...
                oVeiculo.setRenavamVeiculo(rs.getString("renavam_veiculo"));
                oVeiculo.setTipoVeiculo(rs.getString("tipo_veiculo"));
                oVeiculo.setPessoa(new Pessoa(rs.getInt("id_pessoa"), rs.getString("nome_pessoa")));
