...
rg_administrador varchar(12) not null unique,
id_pessoa int not null,
...
cnh_contratado varchar(11) not null unique,
id_pessoa  int not null,
...
CONSTRAINT fk_contratado_veiculo FOREIGN KEY (id_pessoa) references contratado (id_pessoa)
)DEFAULT CHARSET = utf8 AUTO_INCREMENT=1;
...
CONSTRAINT fk_contratado_rota FOREIGN KEY (id_pessoa) references contratado (id_pessoa)
)DEFAULT CHARSET = utf8 AUTO_INCREMENT=1;
...
CONSTRAINT fk_pessoa_produto FOREIGN KEY (id_pessoa) references pessoa (id_pessoa)
)DEFAULT CHARSET = utf8 AUTO_INCREMENT=1;
...
CONSTRAINT fk_pessoa_pedido FOREIGN KEY (id_pessoa) references pessoa (id_pessoa),
...
CONSTRAINT fk_pessoa_entrega FOREIGN KEY (id_pessoa) references pessoa (id_pessoa),
