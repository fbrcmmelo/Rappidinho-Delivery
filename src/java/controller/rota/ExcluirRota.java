 ...
 * @author fbrcmmelo
 */
@WebServlet(name = "ExcluirRota", urlPatterns = {"/ExcluirRota"})
public class ExcluirRota extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("Problemas na Servlet ao Excluir Rota "+ex.getMessage());
            ex.printStackTrace();
        }
    }
