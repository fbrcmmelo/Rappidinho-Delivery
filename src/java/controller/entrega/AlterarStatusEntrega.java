    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.alterarStatusEntrega(Integer.parseInt(request.getParameter("identrega")), request.getParameter("statusentrega").toUpperCase())){
             if(daopedido.alterarStatusPedido(Integer.parseInt(request.getParameter("idpedido")), request.getParameter("statusentrega").toUpperCase()))
                mensagem = "Status da Entrega e Pedido alterado para: " + request.getParameter("statusentrega").toUpperCase();
            } else {
