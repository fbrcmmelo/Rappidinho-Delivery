...
public class ListarProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("cadastros/produto/listarProduto.jsp").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problemas na Servlet ao Listar Produto ! "+ex.getMessage());
            ex.printStackTrace();
        }
    }
