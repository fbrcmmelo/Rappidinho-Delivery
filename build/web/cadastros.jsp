                            ...
                            <div class="white-box">
                                ...
                                <div class="table-responsive">
                                    <table class="table no-wrap">
                                        ...
                                        <tr>
                                            <th class="border-top-0"><h3 class="box-title mb-0">Rotas</h3></th>
                                            <th class="border-top-0"><a href="${pageContext.request.contextPath}/ListarRota" class="btn btn-danger text-white">
                                                    <i class="fa fa-plus" aria-hidden="true"></i> Rota
                                                </a></th>
                                        </tr>
                                         <tr>
                                            <th class="border-top-0"><h3 class="box-title mb-0">Veículos</h3></th>
                                            <th class="border-top-0"><a href="${pageContext.request.contextPath}/ListarVeiculo" class="btn btn-danger text-white">
                                                    <i class="fa fa-plus" aria-hidden="true"></i> Veículo
                                                </a></th>
                                        </tr>
                                         <tr>
                                            <th class="border-top-0"><h3 class="box-title mb-0">Pedidos</h3></th>
                                            <th class="border-top-0"><a href="${pageContext.request.contextPath}/ListarPedido" class="btn btn-danger text-white">
                                                    <i class="fa fa-plus" aria-hidden="true"></i> Pedido
                                                </a></th>
                                        </tr>
                                         <tr>
                                            <th class="border-top-0"><h3 class="box-title mb-0">Produtos</h3></th>
                                            <th class="border-top-0"><a href="${pageContext.request.contextPath}/ListarProduto" class="btn btn-danger text-white">
